...
class Text extends Component {
  ...
  run() {
    ...
    const pause = this.props.pause || ((_this$props$parent2 = this.props.parent) === null || _this$props$parent2 === void 0 ? void 0 : _this$props$parent2.props.pause) || defaultPause;
    setTimeout(() => {
      this.updateInterval();
    }, pause);
  }
  ...
  updateInterval() {
    ...
    let pace = this.str[this.iteration] != '\xa0' ? this.props.pace || ((_this$props$parent3 = this.props.parent) === null || _this$props$parent3 === void 0 ? void 0 : _this$props$parent3.props.pace) || defaultPace : this.props.whiteSpacePace || ((_this$props$parent4 = this.props.parent) === null || _this$props$parent4 === void 0 ? void 0 : _this$props$parent4.props.whiteSpacePace) || this.props.pace || defaultPace;
    this.onStart();
  ...
  play() {
    if (!this.stopped) {
      ...
      const stamp = this.props.stamp || ((_this$props$parent5 = this.props.parent) === null || _this$props$parent5 === void 0 ? void 0 : _this$props$parent5.props.stamp);
      const rewind = this.props.rewind || ((_this$props$parent6 = this.props.parent) === null || _this$props$parent6 === void 0 ? void 0 : _this$props$parent6.props.rewind);
  ...
  onChar() {
    ...
    const rewind = ((_this$props$parent7 = this.props.parent) === null || _this$props$parent7 === void 0 ? void 0 : _this$props$parent7.props.rewind) || this.props.rewind;
    ...
    (_this$props$parent8 = this.props.parent) === null || _this$props$parent8 === void 0 ? void 0 : (_this$props$parent8$p = (_this$props$parent8$p2 = _this$props$parent8.props).onChar) === null || _this$props$parent8$p === void 0 ? void 0 : _this$props$parent8$p.call(_this$props$parent8$p2, char, this.props.parent);
  }
